...
Bright Harbor Careers uses Supabase for durable job, application, account request, department, job board layout, profile, note, scorecard, and role data.
