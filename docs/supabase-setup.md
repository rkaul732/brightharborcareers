...
Bright Harbor Careers uses Supabase for durable job, application, account request, department, job content, job board layout, pipeline configuration, onboarding, communication, profile, note, scorecard, and role data.
